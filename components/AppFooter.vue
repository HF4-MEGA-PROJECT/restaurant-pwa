  ...
  <div class="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 px-4 py-12">
    <div class="flex flex-col items-center justify-center">
      ...
      <div class="flex flex-wrap sm:gap-10 gap-8 items-center justify-center mt-8">
        <p><a href="tel:+4589883200">TLF: +45 89 88 32 00</a></p>
      ...
      <div class="flex items-center gap-x-8 mt-6">
        <button onclick="location.href='https://www.facebook.com/kanyeeast123'" aria-label="facebook" class="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
          <svg
        ...
        <button onclick="location.href='https://www.instagram.com/drayz01/?hl=da'" aria-label="instagram" class="focus:ring-2 focus:ring-offset-2 focus:ring-2 focus:ring-gray-800 focus:outline-none rounded-full">
          <svg
            class="fill-current text-gray-800 hover:text-gray-500"
            width="24"
            height="24"
      ...
      <div class="flex items-center mt-6">
        <p class="text-base leading-4 text-gray-800">
          2022 <span class="font-semibold">Café Vusuvius</span>
        </p>
